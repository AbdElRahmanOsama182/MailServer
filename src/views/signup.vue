        ...
        <form @submit.prevent="Checksignup">
          ...
          <div class="form-group">
            ...
            <v-text-field
              ...
              outlined
            ></v-text-field>
            <!-- <div class="error-message" v-if="$v.userName.$dirty && !$v.userName.maxLength">
              Name must be at most 30 characters long
            </div>
            <div class="error-message" v-if="$v.userName.$dirty && !$v.userName.required">
              Name is required
            </div> -->
          </div>
  ...
  export default {
    ...
    computed: {
      nameErrors() {
        ...
        !this.$v.userName.minLength && errors.push("Name must be at least 3 characters long");
        !this.$v.userName.maxLength && errors.push("Name must be at most 30 characters long");
